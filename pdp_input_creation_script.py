...
BIZ_ALIASES = {
    "base_id": ["base_id", "base id", "keyword_id", "keyword id"],
    "scope_name": ["scope", "scope_name", "partner_id", "partner id"],
    "retailer": ["retailer", "partner_name", "domain_input", "site_name"],
    "retailer_url": ["retailer_url", "retailer url", "url", "product_url", "product page url"],
    ...
    "ean": ["ean", "upc", "gtin", "barcode", "buffer_column_1"],
    ...
    "mainurl": ["mainurl", "main_url", "main url"],
    ...
    "top_sku": ["top_sku", "top sku", "topsku"],
...
CP_ALIASES = {
    ...
    "brand": ["brand"],
    "buffer_column_1": ["buffer_column_1"],
